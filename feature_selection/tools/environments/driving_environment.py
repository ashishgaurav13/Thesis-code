...
class DrivingEnvironment(Environment):
    ...
    def step(self, action):
        ...
        if self.debug['show_reasons'] and done and 'mode' in info.keys() and info['mode'] in ['success', 'termination']:
            print(info, self.total_reward, self.reward_structure._p.t, self.num_acc, self.num_dec)
